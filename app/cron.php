 ...
 *      nog steeds op betaling wachten (standaard na 2 dagen; instelbaar via
 *      'payment_reminder_hours' in app/config.php — bijv. 24 voor na 1 dag).
 *      Nooit meer dan één mail per bestelling.
